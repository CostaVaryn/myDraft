...
public class King {
    ...
    private static void king_step(int x1, int y1, int x2, int y2){
        ...
        } else if (x2 > 8 || x2 < 1 || y2 > 8 || y2 < 1) {
            System.out.println("2");
        } else if (x1 == x2 && y1 == y2) {
            System.out.println("3");
        } else if (y2 == y1 + 1 || y2 == y1 - 1 || x2 == x1 - 1 || x2 == x1 + 1) {
...
Напишите функцию king_step, которая принимает 4 целых числа - сначала координаты клетки, в которой стоит король,
 а потом координаты клетки, в которой стоит фигура, которую он хочет побить. Ваша функция должна вывести на экран:
