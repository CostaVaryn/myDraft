...
public class JToolBarTest extends JFrame {
    ...
    class OpenAction extends AbstractAction {
        ...
        public OpenAction() {
            // Настройка иконок
            putValue(AbstractAction.SMALL_ICON, new ImageIcon("src/test/java/stepik/javabasics/graphicaluserinterface/javaonline/open.png"));
        }
        // Обработка действия
    ...
    class ExitAction extends AbstractAction {
        ...
        public ExitAction() {
            // Настройка иконок
            putValue(AbstractAction.SMALL_ICON, new ImageIcon("src/test/java/stepik/javabasics/graphicaluserinterface/javaonline/exit.png"));
        }
        // Обработка действия
        public void actionPerformed(ActionEvent e) {
            System.exit(0);
