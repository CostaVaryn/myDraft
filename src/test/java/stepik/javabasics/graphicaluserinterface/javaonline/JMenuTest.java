...
public class JMenuTest extends JFrame {
    ...
    private JMenu createFileMenu() {
        ...
        JMenuItem open = new JMenuItem("Открыть",new ImageIcon("src/test/java/stepik/javabasics/graphicaluserinterface/javaonline/open.png"));
        // Пункт меню из команды с выходом из программы
        JMenuItem exit = new JMenuItem(new ExitAction());
        // Добавление к пункту меню изображения
        exit.setIcon(new ImageIcon("src/test/java/stepik/javabasics/graphicaluserinterface/javaonline/exit.png"));
