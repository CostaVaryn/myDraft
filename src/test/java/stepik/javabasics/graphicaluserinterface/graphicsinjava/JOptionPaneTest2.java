...
import static stepik.javabasics.graphicaluserinterface.graphicsinjava.JOptionPaneTest.FONT;
...
public class JOptionPaneTest2 extends JFrame {
    ...
    public JOptionPaneTest2() {
        ...
        icon = new ImageIcon("src/main/resources/warning.png");
    ...
    private void addMessageListeners() {
        btnMessage1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(JOptionPaneTest2.this,
        ...
        btnConfirm1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int result = JOptionPane.showConfirmDialog(
                        JOptionPaneTest2.this,
                        "Вам это нужно?",
                        TITLE_confirm,
                        JOptionPane.YES_NO_CANCEL_OPTION);
                // Окна подтверждения c 2-мя параметрами
                if (result == JOptionPane.YES_OPTION)
                    JOptionPane.showConfirmDialog(JOptionPaneTest2.this,
                            "Вы не отказываетесь?");
    ...
    private void addInputListeners() {
        btnInput1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showInputDialog(JOptionPaneTest2.this,
                        "Вы ответили", result);
            }
        });
        ...
        btnInput3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(JOptionPaneTest2.this, result);
            }
        });
    }
    public static void main(String[] args) {
        JFrame.setDefaultLookAndFeelDecorated(true);
        new JOptionPaneTest2();
    }
}