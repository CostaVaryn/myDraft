    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (str.equalsIgnoreCase("push")) {
                ...
                clothes = list.get(list.size() - 1);
                System.out.println("Петя взял " + clothes);
...
После выполнения всех запросов выведите оставшиеся на стуле вещи.
Гарантируется, что название вещи состоит из одного слова.
